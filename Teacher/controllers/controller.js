...
function insertCell(questionObject, row) {
  ...
  let cell = row.insertCell(index);
  cell.appendChild(
    createIcon(toggleRowColor, questionObject["questionID"], "fa-trash-can alert-danger")
  );
  cell.appendChild(
    createIcon(editQuestion, questionObject["questionID"], "fa-pencil alert-warning")
  );
  UpdateCounts();
}
